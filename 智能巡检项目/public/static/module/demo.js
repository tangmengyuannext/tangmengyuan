//插件加载完毕后，会执行初始化化操作
$(function () {
	WebVideoCtrl.insertPluginObject("divPlugin",800,650);
	//初始化插件
...
function clickLogin()
{
	...
	var szIP = window.top.sessionStorage.getItem('sxtIp');
		szPort = parseInt(window.top.sessionStorage.getItem('sxtPort')) - 0;
		szUsername = window.top.sessionStorage.getItem('userName');
		szPassword = window.top.sessionStorage.getItem('userPwd');
		rtspPort = 80;
		protocol = 1;
	...
	console.log(szIP,szPort,szUsername,szPassword,rtspPort,protocol)
