...
! function (e, t) {
  ...
  for (var n = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {}, o = "undefined" != typeof window ? window : void 0 !== n ? n : "undefined" != typeof self ? self : {}, i = function (e, t) {
      if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
    }, a = function (e, t) {
      if (!e) throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
      return !t || "object" != typeof t && "function" != typeof t ? e : t
    }, s = e.getComponent("Tech"), c = e.dom, u = e.url, l = e.createTimeRange, p = e.mergeOptions, f = o && o.navigator || {}, d = function (e) {
      function t(r, n) {
        i(this, t);
        var s = a(this, e.call(this, r, n));
        return r.source && s.ready(function () {
          this.setSource(r.source)
        }, !0), r.startTime && s.ready(function () {
          this.load(), this.play(), this.currentTime(r.startTime)
        }, !0), o.videojs = o.videojs || {}, o.videojs.Flash = o.videojs.Flash || {}, o.videojs.Flash.onReady = t.onReady, o.videojs.Flash.onEvent = t.onEvent, o.videojs.Flash.onError = t.onError, s.on("seeked", function () {
      ...
      return function (e, t) {
        ...
        var t = this;
        e = u.getAbsoluteURL(e), this.el_.vjs_src(e), this.autoplay() && this.setTimeout(function () {
          return t.play()
        }, 0)
        ...
        return o.performance && "function" == typeof o.performance.now ? e.creationTime = o.performance.now() : o.performance && o.performance.timing && "number" == typeof o.performance.timing.navigationStart && (e.creationTime = o.Date.now() - o.performance.timing.navigationStart), e
      }, t
  ...
  return d.isSupported = function () {
      return !!(e.browser.IS_CHROME && !e.browser.IS_ANDROID || e.browser.IS_SAFARI && !e.browser.IS_IOS) || d.version()[0] >= 10
    }, s.withSourceHandlers(d), d.nativeSourceHandler = {}, d.nativeSourceHandler.canPlayType = function (e) {
      return e in d.formats ? "maybe" : ""
    }, d.nativeSourceHandler.canHandleSource = function (e, t) {
      var r = void 0;
      return r = e.type ? e.type.replace(/;.*/, "").toLowerCase() : function (e) {
        var t = u.getFileExtension(e);
        return t ? "video/" + t : ""
      }(e.src), d.nativeSourceHandler.canPlayType(r)
    }, d.nativeSourceHandler.handleSource = function (e, t, r) {
      t.setSrc(e.src)
    }, d.nativeSourceHandler.dispose = function () {}, d.registerSourceHandler(d.nativeSourceHandler), d.formats = {
      "video/flv": "FLV",
      "video/x-flv": "FLV",
      "video/mp4": "MP4",
      "video/m4v": "MP4"
      ...
      var e = "0,0,0";
      try {
        e = new o.ActiveXObject("ShockwaveFlash.ShockwaveFlash").GetVariable("$version").replace(/\D+/g, ",").match(/^,?(.+),?$/)[1]
      } catch (t) {
        try {
          f.mimeTypes["application/x-shockwave-flash"].enabledPlugin && (e = (f.plugins["Shockwave Flash 2.0"] || f.plugins["Shockwave Flash"]).description.replace(/\D+/g, ",").match(/^,?(.+),?$/)[1])
        } catch (r) {}
      }
      return e.split(",")
    ...
    }(d), s.getTech("Flash") ? (e.log.warn("Not using videojs-flash as it appears to already be registered"), e.log.warn("videojs-flash should only be used with video.js@6 and above")) : e.registerTech("Flash", d), d.VERSION = "2.1.2", d
});
