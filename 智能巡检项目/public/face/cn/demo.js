 ...
 console.log(window.top.sessionStorage.getItem('imgtokens'),'5-5-5',window.top.sessionStorage.getItem('prophttps'));
// var Bearers = "Bearer " + window.top.sessionStorage.getItem('imgtokens'),urlhead = window.top.sessionStorage.getItem('prophttps');
...
var cameraip = "192.168.1.22",cameraport="80",camerauser="admin",camerapassword="ZTXYztxy";
...
function clickCapturePic() {
    $.ajax({
        url: urlhead + "/faceRecognition/recognits",
        type:"post",
        data:{},
        dataType : 'json',
        ...
        success : function(response) {
            console.log(response,'------人脸识别成功');
        },
        error:function(error) {
            console.log(error,'------人脸识别失败');
        } 
    }); 
    // var oWndInfo = WebVideoCtrl.I_GetWindowStatus(g_iWndIndex),
    //     szInfo = "";
	...
	// 	console.log(szPicName,'图片名称2222222222222222222222222222222222222222');
		
    //     var iRet = WebVideoCtrl.I_CapturePic(szPicName, {
    //         bDateDir: false  //是否生成日期文件
    //     });
    //     console.log(iRet,'----iRet33333333333333333333333333333333333333333333333');
    //     if (0 == iRet) {
    //         szInfo = "抓图成功！";
    //             var xmlDoc = WebVideoCtrl.I_GetLocalCfg();
    //             if (xmlDoc != null) {
    ...
    //                 var address = szPicName;
    //                 console.log(address,'------address',urlhead + '/faceRecognition/recognits');
    //                 $(".imgaddress").val(address);
    //                 window.parent.postMessage({data:imgaddressprop},'*');
    //                 urlimg = imgaddressprop;
