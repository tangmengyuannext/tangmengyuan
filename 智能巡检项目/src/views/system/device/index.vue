<template>
  <div class="app-container">
    ...
    >
      <el-table-column prop="deviceName" label="设备名称" width="260"></el-table-column>
        ...
        <el-row>
          <el-col :span="24" v-if="form.parentId !== 0">
            <el-form-item label="上级设备" prop="parentId">
              <treeselect v-model="form.parentId" :options="deviceOptions" :normalizer="normalizer" placeholder="选择上级设备" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
<script>
import { listDevice, getDevice, delDevice, addDevice, updateDevice, listDeviceExcludeChild } from "@/api/system/device";
  ...
  methods: {
    ...
    handleAdd(row) {
      ...
      listDevice().then(response => {
	        this.deviceOptions = this.handleTree(response.data, "deviceId");
      });
    },
    /** 修改按钮操作 */
    handleUpdate(row) {
