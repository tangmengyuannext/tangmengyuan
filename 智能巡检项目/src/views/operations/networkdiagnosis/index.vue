<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="100px">
        ...
        <!-- <el-form-item label="设备缺陷" prop="defectId">
          <el-select v-model="queryParams.defectId" clearable filterable placeholder="请选择">
            <el-option
              v-for="dict in gaojingsuanfaoptions"
              :key="dict.defectId"
    ...
    <el-table v-loading="loading" :data="listHistory" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="事件名称" align="center" prop="alarmType" />
       ...
       <el-table-column label="上传速度" align="center" prop="defectName" />
      <el-table-column label="下载速度" align="center" prop="endTime" />
...
<script>
// import { listConfiguration, getConfiguration, delConfiguration, addConfiguration, updateConfiguration, exportConfiguration } from "@/api/api/operations/networkdiagnosis"
