    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" icon="el-icon-plus" size="mini" @click="handleAdd" 
          v-hasPermi="['alarm:defects:add']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="success" icon="el-icon-edit" size="mini" :disabled="single" @click="handleUpdate" 
          v-hasPermi="['alarm:defects:edit']">修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" icon="el-icon-delete" size="mini" :disabled="multiple" @click="handleDelete"
          v-hasPermi="['alarm:defects:remove']">删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning" icon="el-icon-download" size="mini" @click="handleExport"
          v-hasPermi="['alarm:defects:export']">导出</el-button>
      </el-col>
    </el-row>
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          ...
          <el-button
            ...
            v-hasPermi="['alarm:defects:remove']"
          >删除</el-button>
        </template>
      </el-table-column>
    </el-table>
...
export default {
  ...
  methods: {
    ...
    /** 查询缺陷列表 */
    getList() {
      listDefects(this.queryParams).then(response => {
    ...
    handleUpdate(row) {
      ...
      getDefects(defectId).then(response => {
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          ...
          if (this.form.defectId != undefined) {
            updateDefects(this.form).then(response => {
            ...
            addDefects(this.form).then(response => {
    ...
    handleExport() {
      ...
      this.$confirm("是否确认导出所有缺陷数据项?", "警告", {
        ...
        .then(function() {
          return exportDefects(queryParams);
        }) 
        .then(response => {
