  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" :rules="queryParamsrules" label-width="125px">
      ...
      <el-form-item label="终端类型" prop="smallType">
        <el-select v-model="queryParams.smallType" placeholder="请选择智能感知终端类型">
          <el-option
    ...
    <el-table v-loading="loading" :data="cameraList" :cell-class-name="textOverflow" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="ID" align="center" prop="cameraId"/>
      ...
      <el-table-column label="是否预置位" align="center" prop="hasSite" :formatter="isYesOrNoFormat"/>
      <el-table-column label="是否红外线" align="center" prop="hasInfrared" :formatter="isYesOrNoFormat"/>
      <el-table-column label="是否有云台" align="center" prop="hasPtz" :formatter="isYesOrNoFormat"/>
      <el-table-column label="是否有对讲" align="center" prop="hasTbk" :formatter="isYesOrNoFormat"/>
      <el-table-column label="是否有NVR" align="center" prop="hasNvr" :formatter="isYesOrNoFormat"/>
    ...
    <el-dialog :title="title" :visible.sync="open" width="700px" :modal-append-to-body="false">
      <el-form ref="form" :model="form" :rules="rules" label-width="150px">
        ...
        <el-form-item label="智能感知终端品牌" prop="model.brand" >
...
export default {
  ...
  methods: {
    ...
    /** 配置按钮操作 */
    handleConfig(row){
      console.log(row,row.model.bigType == "6");
