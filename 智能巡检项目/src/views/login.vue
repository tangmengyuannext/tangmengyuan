<template>
  <div class="login">
    ...
    <div class="el-login-footer">
      <span>Copyright © 2019-2020 psim.com All Rights Reserved.</span>
    </div>
  </div>
</template>
    ...
    return {
      ...
      loginRules: {
        username: [
          ...
          // { pattern:  /^[ABCEGHJKLMNPRSTVXY]{1}\d{1}[A-Z]{1} *\d{1}[A-Z]{1}\d{1}$/, message: '区分大小写' }
        ],
        password: [
      ...
      this.$refs.loginForm.validate(valid => {
        if (valid) {
          ...
          if (this.loginForm.rememberMe) {
            ...
            Cookies.remove("username");XMLDocument
